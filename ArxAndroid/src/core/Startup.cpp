...
#ifdef ANDROID
#include <string>
#include "../graphics/opengl/TextureCache.h"
static std::string g_pathToResources;
#endif
...
void setPathToResources (const char *pathToResources){
    g_pathToResources = pathToResources;
}
}
#endif
